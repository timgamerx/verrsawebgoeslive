...
export default function ProfileSetting() {
  ...
  const loadUserProfile = async () => {
    try {
      ...
      if (!user) {
        ...
        window.alert("Please log in again to view your profile.");
        return;
      }
  ...
  const handleVerification = () => {
    ...
    if (window.confirm("This will redirect you to the verification process. Continue?")) { router.push("/monetization") }
  };
